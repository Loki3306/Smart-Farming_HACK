...
export const IRRIGATION_CONTENT: LessonContent[] = [
  {
    ...
    description:
      "Understand how modern irrigation systems save water and increase crop yield.",
    content_type: "video",
  ...
  },
  {
    ...
    description:
      "Learn which irrigation system is best for your crops and land.",
    content_type: "text",
    duration: "15 min",
    is_preview: false,
    article: {
      introduction:
        "Choosing the right irrigation system can reduce your water bill by 40-60% while improving crop health. Let's understand the differences between drip and sprinkler systems so you can make the best choice for your farm.",
      sections: [
        {
          title: "💧 What is Drip Irrigation?",
          content:
            "Drip irrigation delivers water slowly, drop by drop, directly to plant roots through small tubes. Think of it like giving each plant its own water bottle. This method is best for row crops like vegetables, fruits, and cotton.",
          tips: [
        ...
        },
        {
          ...
          content:
            "Sprinkler irrigation sprays water into the air like rain. It covers large areas and is good for crops that benefit from wet leaves like wheat, groundnut, and fodder crops. It's also great for uneven land.",
          tips: [
        ...
        },
        {
          ...
          content:
            "Modern farms use soil moisture sensors to know exactly when to water. The sensor checks if soil is dry or wet and tells you through your phone. This prevents both over-watering and under-watering.",
          tips: [
      ...
      summary:
        "Drip irrigation is best for vegetables and fruits, saving 40-60% water. Sprinkler works better for wheat and field crops on uneven land. Both have government subsidies up to 55-90%. Combine with soil sensors for smart, automated irrigation.",
    },
  },
  {
    title: "Water Scheduling Strategies",
    description:
      "Learn when and how much to water your crops for best results.",
    content_type: "text",
    duration: "12 min",
    is_preview: false,
    article: {
      introduction:
        "Watering at the right time is just as important as using the right system. Many farmers water too much or at the wrong time, wasting water and harming crops. This lesson teaches you the smart way to schedule irrigation.",
      sections: [
        {
          title: "⏰ Best Time to Water",
          content:
            "The best time to irrigate is early morning (6-9 AM) or late evening (after 5 PM). During midday, 30-40% of water evaporates before reaching roots. Morning watering is best because:\n• Less evaporation\n• Plants use water all day\n• Leaves dry quickly, preventing disease",
          tips: [
        ...
        },
        {
          ...
          content:
            "Smart farmers check weather before irrigating. If rain is expected in 1-2 days, skip irrigation and save water. Our app shows 5-day weather forecast and alerts you before rain.",
          tips: [
      ...
      summary:
        "Water early morning (6-9 AM) or evening to reduce evaporation. Always check weather forecast before irrigating. Use the finger test - if soil 2 inches deep is dry, it's time to water. Adjust water amount based on crop growth stage.",
    },
  },
  {
    title: "Maintenance & Troubleshooting",
    description:
      "Keep your irrigation system running smoothly with these maintenance tips.",
    content_type: "video",
      ...
      questions: [
        {
          ...
          correctIndex: 1,
          explanation:
            "Early morning (6-9 AM) is the best time because evaporation is lowest and plants can use water throughout the day. Midday irrigation loses 30-40% water to evaporation.",
        },
        {
          question:
            "How much water does drip irrigation save compared to flood irrigation?",
          options: ["10-20%", "20-30%", "40-60%", "80-90%"],
          correctIndex: 2,
          explanation:
            "Drip irrigation saves 40-60% water compared to traditional flood irrigation by delivering water directly to plant roots, reducing evaporation and runoff.",
        },
        {
          question:
            "If heavy rain (>20mm) is expected tomorrow, what should you do?",
          options: [
            "Irrigate extra today to store water",
            "Skip irrigation for 2-3 days",
            "Continue normal irrigation",
            "Irrigate immediately after rain",
          ],
          correctIndex: 1,
          explanation:
            "Heavy rain (>20mm) provides enough moisture. Skip irrigation for 2-3 days to avoid waterlogging and save water. Check soil moisture before resuming.",
        },
        {
          ...
          correctIndex: 2,
          explanation:
            "Flowering stage is most critical for water. Stress during flowering causes flower drop and poor fruit/grain formation, directly reducing yield.",
        },
        {
          question:
            "In the finger test, how deep should you check soil moisture?",
          options: [
            "Surface level",
            "2 inches deep",
            "6 inches deep",
          ...
          correctIndex: 1,
          explanation:
            "Check soil moisture 2 inches deep (about finger length). Surface can be dry while roots have enough water. This depth shows actual root zone moisture.",
        },
        {
          ...
          correctIndex: 1,
          explanation:
            "Sprinkler irrigation is ideal for wheat because it covers large areas efficiently and wheat benefits from overhead watering. Drip is better for row crops like vegetables.",
        },
        {
          ...
          correctIndex: 2,
          explanation:
            "Drip irrigation has 90-95% water efficiency because water goes directly to roots with minimal evaporation or runoff. This is the highest among all irrigation methods.",
        },
      ],
    },
  },
