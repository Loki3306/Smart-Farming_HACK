...
export const PEST_CONTROL_CONTENT: LessonContent[] = [
  {
    ...
    description:
      "Learn to recognize the most common pests that damage crops in Indian farms.",
    content_type: "video",
  ...
  },
  {
    ...
    description:
      "Use natural predators and organic methods to control pests without chemicals.",
    content_type: "text",
    duration: "18 min",
    is_preview: false,
    article: {
      introduction:
        "Nature has its own pest control system. By understanding it, you can protect your crops without expensive chemicals that harm soil and health. This lesson teaches you proven biological methods used by successful organic farmers.",
      sections: [
        {
          title: "🐞 Beneficial Insects - Nature's Pest Killers",
          content:
            "Some insects eat harmful pests. These are your farm's natural helpers:\n\n• LADYBUGS: One ladybug eats 50 aphids per day\n• LACEWINGS: Larvae eat aphids, mites, small caterpillars\n• DRAGONFLIES: Eat mosquitoes and small flies\n• SPIDERS: Catch many flying pests in webs\n\nNever kill these helpful insects!",
          tips: [
      ...
      summary:
        "Biological pest control uses nature's own methods - beneficial insects, neem, garlic-chili spray, and traps. These methods are cheaper, safer, and sustainable. Start with neem spray and sticky traps, then build up beneficial insect population.",
    },
  },
  {
    title: "Safe Chemical Usage",
    description:
      "When you must use chemicals, learn to do it safely and effectively.",
    content_type: "video",
      ...
      questions: [
        {
          ...
          correctIndex: 2,
          explanation:
            'One ladybug can eat up to 50 aphids per day! This is why ladybugs are called "farmer\'s friends" - they provide free, natural pest control.',
        },
        {
          question:
            "What is the correct neem oil concentration for pest spray?",
          options: [
            "5ml per liter water",
            "50ml per liter water",
            "100ml per liter water",
            "500ml per liter water",
          ],
          correctIndex: 0,
          explanation:
            "5ml neem oil per liter of water is the correct concentration. Higher amounts can burn plant leaves. Add 1ml soap to help it mix with water.",
        },
        {
          ...
          correctIndex: 1,
          explanation:
            "Spray neem oil early morning or evening. Midday sunlight breaks down neem quickly, reducing its effectiveness. Evening is slightly better as it stays on leaves longer.",
        },
        {
          ...
          correctIndex: 1,
          explanation:
            "Yellow sticky traps are most effective for whiteflies, aphids, and fungus gnats. These pests are naturally attracted to yellow color.",
        },
        {
          question:
            "What should you add to garlic-chili spray to help it stick to leaves?",
          options: ["Sugar", "Salt", "Soap", "Oil"],
          correctIndex: 2,
          explanation:
            "Adding a small amount of soap helps the spray stick to leaves and spread evenly. Without soap, the spray beads up and rolls off.",
        },
        {
          ...
          correctIndex: 2,
          explanation:
            "Marigold flowers attract beneficial insects like ladybugs and lacewings while repelling many harmful pests. Plant them around vegetable plots.",
        },
      ],
    },
  },
...
export const SOIL_HEALTH_CONTENT: LessonContent[] = [
  {
    ...
    description:
      "Learn about different soil types and what grows best in each.",
    content_type: "video",
  ...
  },
  {
    ...
    description:
      "Know your soil's health and how to improve it for better crops.",
    content_type: "text",
    duration: "15 min",
    is_preview: false,
    article: {
      introduction:
        "Would you take medicine without knowing your illness? Similarly, adding fertilizers without knowing soil condition wastes money and can harm crops. Soil testing tells you exactly what your soil needs.",
      sections: [
        {
      ...
      summary:
        "Soil testing costs ₹50-100 but saves thousands in wrong fertilizers. Check pH, NPK, and organic carbon. Most crops prefer pH 6.5-7.5. Get your free Soil Health Card and test every 6 months for best results.",
    },
  },
  {
    title: "Nutrient Management (NPK)",
    description:
      "Balance nitrogen, phosphorus and potassium for healthy crops.",
    content_type: "video",
  ...
  },
  {
    ...
    description:
      "Improve soil naturally by growing and incorporating specific plants.",
    content_type: "text",
    duration: "12 min",
    is_preview: false,
    article: {
      introduction:
        "What if you could grow your own fertilizer? Green manuring does exactly that! By growing and plowing certain plants into soil, you add nutrients and organic matter naturally. This practice has been used in India for thousands of years.",
      sections: [
        {
          title: "🌱 What is Green Manuring?",
          content:
            "Green manuring means growing specific crops and then plowing them into soil before your main crop. These plants add:\n• Nitrogen (especially legumes)\n• Organic matter\n• Improve soil structure\n• Suppress weeds\n\nBest green manure crops: Dhaincha, Sunhemp, Cowpea, Moong",
          tips: [
      ...
      summary:
        "Green manuring is like growing free fertilizer. Sow dhaincha or sunhemp, plow in after 45-50 days, and get 60-100 kg nitrogen per hectare naturally. It also improves soil structure and suppresses weeds.",
    },
  },
  {
      ...
      questions: [
        {
          ...
          correctIndex: 1,
          explanation:
            "Most vegetables grow best in slightly acidic to neutral soil (pH 6.5-7.5). At this pH, nutrients are most available to plants.",
        },
        {
          ...
          correctIndex: 1,
          explanation:
            "N stands for Nitrogen, which is essential for leaf growth and green color. Nitrogen deficiency causes yellow leaves and stunted growth.",
        },
        {
          ...
          correctIndex: 2,
          explanation:
            "Collect soil from 6-8 inches deep, which is the main root zone where plants absorb nutrients. Surface soil doesn't represent the root zone accurately.",
        },
        {
          ...
          correctIndex: 2,
          explanation:
            "Dhaincha (Sesbania) adds 80-100 kg nitrogen per hectare when plowed in at 45-50 days. This is equivalent to about 200 kg urea!",
        },
        {
          question: "When should you plow in green manure crop?",
          options: [
            "When it has seeds",
            "At 45-50 days (before flowering)",
            "After 6 months",
            "Only in winter",
          ],
          correctIndex: 1,
          explanation:
            "Plow in green manure at 45-50 days, before flowering. After this, plants become woody and don't decompose well. Seeds can become weeds.",
        },
        {
          ...
          correctIndex: 2,
          explanation:
            "Brown or burnt edges on leaves indicate potassium (K) deficiency. Potassium is important for fruit quality and disease resistance.",
        },
      ],
    },
  },
