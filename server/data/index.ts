...
export function findContentForCourse(
  courseName: string,
): LessonContent[] | null {
...
export const FULL_COURSE_DEFINITIONS = [
  {
    ...
    description:
      "Learn to grow crops without harmful chemicals using traditional Indian methods combined with modern organic practices.",
  ...
  },
  {
    ...
    description:
      "Master water management with drip irrigation, scheduling, and conservation techniques for better yields with less water.",
  ...
  },
  {
    ...
    slug: "pest-control",
    description:
      "Identify and control pests using biological methods, neem-based sprays, and integrated pest management.",
    difficulty_level: "intermediate",
    estimated_hours: 3,
  ...
  },
  {
    ...
    slug: "soil-health",
    description:
      "Understand soil testing, pH management, NPK balance, and green manuring for healthier, more productive land.",
    difficulty_level: "intermediate",
    estimated_hours: 3,
  ...
  },
  {
    ...
    slug: "farm-equipment",
    description:
      "Learn tractor maintenance, harvester operation, government subsidies, and when to rent vs buy equipment.",
    difficulty_level: "beginner",
    estimated_hours: 3,
  ...
  },
  {
    ...
    slug: "smart-farming",
    description:
      "Use smartphone apps, weather forecasting, and basic sensors to make better farming decisions.",
    difficulty_level: "beginner",
    estimated_hours: 2,
