...
export const ORGANIC_FARMING_CONTENT: LessonContent[] = [
  {
    ...
    description:
      "Learn the core concepts of sustainable agriculture and why organic farming benefits your land.",
    content_type: "video",
  ...
  },
  {
    ...
    description:
      "Master the art of preparing healthy soil using natural composting methods.",
    content_type: "text",
    duration: "15 min",
    is_preview: false,
    article: {
      ...
      sections: [
        {
          ...
          content:
            "Think of soil as a living thing - it contains millions of tiny organisms that help your crops grow. When soil is healthy, it holds water better, provides nutrients to plants, and fights off diseases naturally. Farmers who focus on soil health often see 20-30% better yields within 2-3 years.",
          tips: [
        ...
        },
        {
          ...
          content:
            'Composting is nature\'s way of recycling. You can turn farm waste, kitchen scraps, and animal manure into rich fertilizer for free! The key is balancing "green" materials (fresh grass, vegetable waste) with "brown" materials (dry leaves, straw).',
          tips: [
      ...
      summary:
        "Good soil preparation starts with composting. Mix green and brown materials, keep moist, turn regularly, and in 2-3 months you'll have free, natural fertilizer. Healthy soil means healthy crops and better income for your family.",
    },
  },
  {
    title: "Natural Pest Management",
    description:
      "Protect your crops from pests without harmful chemicals using traditional and modern techniques.",
    content_type: "video",
  ...
  },
  {
    ...
    description:
      "Learn how to get your farm certified organic and access premium markets.",
    content_type: "text",
    duration: "12 min",
    is_preview: false,
    article: {
      introduction:
        "Organic certification can help you sell your produce at 20-50% higher prices. While the process takes time, it is worth the effort. This lesson explains exactly what you need to do to get certified in India.",
      sections: [
        {
          title: "📜 What is Organic Certification?",
          content:
            "Organic certification is an official document that proves your farm follows organic practices. It is like a guarantee to buyers that your produce is chemical-free. In India, you can get certified through PGS (Participatory Guarantee System) for local markets or through agencies like APEDA for export.",
        },
        {
      ...
      summary:
        "Organic certification takes 2-3 years but opens doors to premium prices. Start with PGS certification by forming a farmer group. Keep records, follow organic practices, and you'll soon have an official certificate to prove your produce quality.",
    },
  },
  {
      ...
      questions: [
        {
          ...
          correctIndex: 1,
          explanation:
            "The ideal ratio is 3 parts brown (dry leaves, straw) to 1 part green (fresh grass, vegetable waste). This balance provides the right carbon-to-nitrogen ratio for proper decomposition.",
        },
        {
          question:
            "How long does it typically take for compost to be ready in summer?",
          options: ["1-2 weeks", "6-8 weeks", "6 months", "1 year"],
          correctIndex: 1,
          explanation:
            "In warm summer conditions, compost can be ready in 6-8 weeks with proper turning and moisture. In winter, it takes longer (3-4 months).",
        },
        {
          ...
          correctIndex: 2,
          explanation:
            "Testing soil every 6 months helps you track soil health changes and adjust your composting and farming practices accordingly.",
        },
        {
          ...
          correctIndex: 1,
          explanation:
            "The squeeze test checks moisture level. When you squeeze compost, only a few drops of water should come out - not too wet, not too dry.",
        },
        {
          question:
            "How long must you follow organic practices before getting PGS certification?",
          options: ["1 month", "6 months", "1 year", "3 years"],
          correctIndex: 2,
          explanation:
            "For PGS-India certification, you need to follow organic practices for at least 1 year. For export certification, it can be 2-3 years.",
        },
        {
          ...
          correctIndex: 2,
          explanation:
            "Never add meat, fish, or oily foods to compost. They attract pests, create bad smells, and can spread diseases.",
        },
      ],
    },
  },
