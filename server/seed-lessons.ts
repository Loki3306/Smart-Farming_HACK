...
const LESSON_TEMPLATES = {
  organic: [
    {
      ...
      content_type: "video",
      content_url: "https://www.youtube.com/watch?v=oiyOfJJjkVc",
      duration: "15 min",
      is_preview: true,
    },
    {
      title: "Soil Preparation & Composting",
      description: "Preparing your land naturally.",
      content_type: "text",
      content_url: null,
      duration: "20 min",
      is_preview: false,
    },
    {
      ...
      description: "How to get your farm certified.",
      content_type: "video",
      content_url: "https://www.youtube.com/watch?v=nkn7TqAhJZE",
      duration: "12 min",
      is_preview: false,
    },
    {
      title: "Market Opportunities",
      description: "Selling organic produce for better prices.",
      content_type: "text",
      content_url: null,
      duration: "10 min",
      is_preview: false,
    ...
    {
      title: "Quiz: Organic Fundamentals",
  ...
  irrigation: [
    {
      ...
      description: "Choosing the right system for your crop.",
      content_type: "video",
      content_url: "https://www.youtube.com/watch?v=QD6YkWqaXJw",
      duration: "18 min",
      is_preview: true,
    },
    {
    ...
    },
    {
      ...
      description: "Keeping your system running efficiently.",
      content_type: "video",
  ...
  pest: [
    {
      ...
      description: "Visual guide to farm pests.",
      content_type: "video",
    ...
    },
    {
      ...
      description: "Using nature to fight pests.",
      content_type: "text",
      content_url: null,
      duration: "25 min",
      is_preview: false,
    },
    {
      ...
      description: "When and how to use pesticides safely.",
      content_type: "video",
      content_url: null,
      duration: "15 min",
      is_preview: false,
  ...
  soil: [
    {
      ...
      description: "Why pH matters for your crops.",
      content_type: "video",
      content_url: null,
      duration: "10 min",
      is_preview: true,
    },
    {
      ...
      description: "Balancing Nitrogen, Phosphorus, and Potassium.",
      content_type: "text",
      content_url: null,
      duration: "30 min",
      is_preview: false,
    },
    {
      ...
      description: "How to take soil samples correctly.",
      content_type: "video",
      content_url: null,
      duration: "15 min",
      is_preview: false,
    },
    {
      ...
      description: "Improving soil structure naturally.",
      content_type: "text",
      content_url: null,
      duration: "12 min",
      is_preview: false,
  ...
  equipment: [
    ...
    },
    {
      ...
      description: "Daily and weekly checks.",
      content_type: "text",
      content_url: null,
      duration: "15 min",
      is_preview: false,
    ...
    {
      title: "Implement Attachment Guide",
      description: "Connecting plows and seeders correctly.",
      content_type: "video",
      content_url: null,
      duration: "25 min",
      is_preview: false,
    },
    {
      ...
      description: "Fixing minor problems on the field.",
      content_type: "text",
      content_url: null,
      duration: "20 min",
      is_preview: false,
...
async function seedLessons() {
  ...
  for (const course of courses) {
    ...
    if (
      ...
      title.includes("जैविक") ||
      title.includes("सेंद्रिय")
    ) {
      lessonsToAdd = LESSON_TEMPLATES.organic;
    } else if (
      title.includes("irrigation") ||
      title.includes("सिंचाई") ||
      title.includes("सिंचन")
    ) {
    ...
    if (lessonsToAdd.length > 0) {
      ...
      if (count === 0) {
        console.log(
          `📝 Adding ${lessonsToAdd.length} lessons to course: "${course.title}"`,
        );
        ...
        if (insertError) {
          console.error(
            `❌ Failed to insert lessons for "${course.title}":`,
            insertError,
          );
        } else {
        ...
        console.log(
          `⏭️  Skipping "${course.title}" (already has ${count} lessons)`,
        );
      }
    } else {
