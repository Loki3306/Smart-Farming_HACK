...
describe("Tour Storage Utilities", () => {
  ...
  describe("setTourCompleted", () => {
    it("marks a tour as completed in localStorage", () => {
      ...
      expect(localStorage.getItem("smartfarm_tour_main-tour_completed")).toBe(
        "true",
      );
    });
    ...
    it("stores completion timestamp", () => {
      ...
      const timestamp = localStorage.getItem(
        "smartfarm_tour_main-tour_completed_at",
      );
  ...
  describe("resetTour", () => {
    ...
    it("removes completion timestamp", () => {
      ...
      resetTour("main-tour");
      expect(
        localStorage.getItem("smartfarm_tour_main-tour_completed_at"),
      ).toBeNull();
    });
  });
