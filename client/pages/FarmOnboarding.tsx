    ...
    if ("geolocation" in navigator) {
      navigator.geolocation.getCurrentPosition(
        async (position) => {
          ...
          const locationValidation = validateIndianLocation(
            latitude,
            longitude,
          );
          ...
          if (geoResult.success) {
            ...
            setErrors((prev) => ({
              ...prev,
              gpsError:
                "Location captured but couldn't fetch address details. Please enter manually.",
            }));
          }
    ...
    try {
      const result = await saveFarmerOnboarding({
        farmer: {
          ...
          phone:
            validateIndianPhone(farmData.phoneNumber).normalized ||
            farmData.phoneNumber, // Normalize to +91XXXXXXXXXX
            ...
            <div className="space-y-6">
              ...
              {step === 2 && (
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    We'll send you important alerts about your farm on this
                    number.
                  </p>
                  ...
                  {!showOtpInput ? (
                    ...
                    <Card className="p-4">
                      <OtpInput
                        phoneNumber={
                          validateIndianPhone(farmData.phoneNumber)
                            .normalized || farmData.phoneNumber
                        }
                    ...
                    {farmData.latitude && farmData.longitude && (
                      <div className="bg-card rounded p-3 text-sm space-y-1">
                        ...
                        <p className="text-muted-foreground text-xs">
                          Coordinates: {farmData.latitude.toFixed(6)}°N,{" "}
                          {farmData.longitude.toFixed(6)}°E
                        </p>
                      </div>
                    )}
              ...
              {step === 4 && (
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    Connect your smart sensor to start receiving real-time farm
                    data.
                  </p>
                    ...
                    {!farmData.sensorConnected ? (
                      <>
                        ...
                        <Button
                          onClick={() => {
                            handleConnectSensor();
                            setGuideAction("SENSOR_CONNECTING");
                          }}
                  ...
                  <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-2 gap-3 text-sm">
                        ...
                        <div>
                          ...
                          <p className="font-medium">
                            {farmData.yearsExperience || "Not specified"}
                          </p>
                        </div>
                      </div>
                    </Card>
                    ...
                    <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-4">
                      <p className="text-sm text-emerald-800">
                        <strong>🔒 Your data is encrypted</strong> - Phone,
                        email, and sensitive information are securely encrypted
                        before being stored.
                      </p>
                    </div>
                  </div>
