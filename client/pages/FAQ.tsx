...
export const FAQ: React.FC = () => {
  ...
  const categories = [
    {
      id: "all",
      name: language === "hi" ? "सभी सवाल" : "All Questions",
      icon: <HelpCircle className="w-4 h-4" />,
    },
    {
      id: "getting-started",
      name: language === "hi" ? "शुरुआत" : "Getting Started",
      icon: <PlayCircle className="w-4 h-4" />,
    },
    {
      id: "features",
      name: language === "hi" ? "फीचर" : "Features",
      icon: <Sparkles className="w-4 h-4" />,
    },
    {
      id: "ai",
      name: language === "hi" ? "AI और सुझाव" : "AI & Recommendations",
      icon: <TrendingUp className="w-4 h-4" />,
    },
    {
      id: "learning",
      name: language === "hi" ? "सीखना" : "Learning Hub",
      icon: <BookOpen className="w-4 h-4" />,
    },
    {
      id: "community",
      name: language === "hi" ? "समुदाय" : "Community",
      icon: <Users className="w-4 h-4" />,
    },
    {
      id: "technical",
      name: language === "hi" ? "तकनीकी" : "Technical",
  ...
  const faqs: FAQItem[] = [
    ...
    },
    {
      ...
      answer:
        "The platform currently supports English, Hindi, and Marathi. You can change your language preference anytime from the settings. All tours, recommendations, and learning content are available in your selected language. We're working on adding more regional languages based on user demand.",
      answerHi:
        "प्लेटफॉर्म वर्तमान में अंग्रेजी, हिंदी और मराठी का समर्थन करता है। आप सेटिंग्स से कभी भी अपनी भाषा प्राथमिकता बदल सकते हैं। सभी टूर, सिफारिशें और सीखने की सामग्री आपकी चयनित भाषा में उपलब्ध हैं। हम उपयोगकर्ता की मांग के आधार पर अधिक क्षेत्रीय भाषाएं जोड़ने पर काम कर रहे हैं।",
      category: "getting-started",
    },
    ...
    },
    {
      ...
      questionHi:
        "क्या मुझे सेंसर की आवश्यकता है या मैं मैन्युअल रूप से डेटा दर्ज कर सकता हूं?",
      answer:
      ...
      answerHi:
        "आप प्लेटफॉर्म दोनों तरीकों से उपयोग कर सकते हैं! IoT सेंसर के साथ: स्वचालित डेटा संग्रह, रियल-टाइम निगरानी, अधिक सटीक AI पूर्वानुमान, और तत्काल अलर्ट। सेंसर के बिना: मैनुअल डेटा प्रविष्टि (मिट्टी की स्थिति, अवलोकन), मौसम-आधारित सिफारिशें, और सीखने के संसाधन अभी भी उपलब्ध हैं। हम इष्टतम अनुभव के लिए सेंसर की सिफारिश करते हैं, लेकिन प्लेटफॉर्म उनके बिना पूरी तरह कार्यात्मक है।",
      category: "ai",
    },
    ...
    // Learning Hub
    {
      ...
      answer:
        "The Learning Hub is your free educational resource center with 50+ courses on topics like crop management, pest control, organic farming, IoT in agriculture, 200+ articles with quick farming tips and seasonal guides, 100+ video tutorials in multiple languages, and content organized by difficulty level (beginner, intermediate, advanced). All content is created by agricultural experts and available in your preferred language.",
      answerHi:
        "लर्निंग हब आपका मुफ्त शैक्षिक संसाधन केंद्र है जिसमें फसल प्रबंधन, कीट नियंत्रण, जैविक खेती, कृषि में IoT जैसे विषयों पर 50+ पाठ्यक्रम हैं, त्वरित खेती टिप्स और मौसमी मार्गदर्शिकाओं के साथ 200+ लेख, कई भाषाओं में 100+ वीडियो ट्यूटोरियल, और कठिनाई स्तर (शुरुआती, मध्यवर्ती, उन्नत) द्वारा संगठित सामग्री। सभी सामग्री कृषि विशेषज्ञों द्वारा बनाई गई है और आपकी पसंदीदा भाषा में उपलब्ध है।",
      category: "learning",
    ...
    },
    {
      ...
      answer:
        "Yes! All courses, articles, and videos are completely free for all users. We believe in democratizing agricultural education. Certificates of completion are available for finished courses. You can download and share them. Many courses include quizzes to test your understanding, and you can track your learning progress from your profile.",
      answerHi:
        "हां! सभी पाठ्यक्रम, लेख और वीडियो सभी उपयोगकर्ताओं के लिए पूरी तरह से मुफ्त हैं। हम कृषि शिक्षा के लोकतंत्रीकरण में विश्वास करते हैं। पूर्ण पाठ्यक्रमों के लिए पूर्णता प्रमाणपत्र उपलब्ध हैं। आप उन्हें डाउनलोड और साझा कर सकते हैं। कई पाठ्यक्रमों में आपकी समझ का परीक्षण करने के लिए प्रश्नोत्तरी शामिल हैं, और आप अपनी प्रोफ़ाइल से अपनी सीखने की प्रगति को ट्रैक कर सकते हैं।",
      category: "learning",
    },
    ...
    },
    {
      ...
      answer:
        "Verified experts are agricultural specialists, agronomists, government agricultural officers, experienced farmers with proven track records, and agricultural researchers. They're marked with a special badge and their advice is highlighted. You can follow them to get their latest posts and recommendations in your feed.",
      answerHi:
        "सत्यापित विशेषज्ञ कृषि विशेषज्ञ, कृषि विज्ञानी, सरकारी कृषि अधिकारी, सिद्ध ट्रैक रिकॉर्ड वाले अनुभवी किसान, और कृषि शोधकर्ता हैं। उन्हें एक विशेष बैज के साथ चिह्नित किया गया है और उनकी सलाह को हाइलाइट किया गया है। आप अपनी फीड में उनकी नवीनतम पोस्ट और सिफारिशें प्राप्त करने के लिए उन्हें फॉलो कर सकते हैं।",
      category: "community",
    },
    ...
    // Marketplace
    {
      ...
      answer:
        "Buy: Seeds and saplings, fertilizers and pesticides, farming equipment and tools, irrigation supplies, IoT sensors and smart devices. Sell: Your harvested crops, surplus produce, organic products, by-products (like organic compost). All transactions are secure, and you can compare prices from multiple sellers.",
      answerHi:
        "खरीदें: बीज और पौधे, उर्वरक और कीटनाशक, खेती के उपकरण और औजार, सिंचाई आपूर्ति, IoT सेंसर और स्मार्ट उपकरण। बेचें: आपकी कटी हुई फसलें, अधिशेष उपज, जैविक उत्पाद, उप-उत्पाद (जैसे जैविक खाद)। सभी लेनदेन सुरक्षित हैं, और आप कई विक्रेताओं से कीमतों की तुलना कर सकते हैं।",
      category: "features",
    ...
    },
    {
      ...
      answer:
        "You'll receive notifications for critical weather alerts (rain, extreme temperatures, storms), time-sensitive farming activities, low soil moisture or nutrient levels, new AI recommendations, community responses to your posts, and marketplace updates. Notifications are available in-app, via SMS, and phone calls for emergencies. You can customize notification preferences in settings.",
      answerHi:
        "आपको महत्वपूर्ण मौसम अलर्ट (बारिश, चरम तापमान, तूफान), समय-संवेदनशील खेती गतिविधियों, कम मिट्टी की नमी या पोषक तत्व स्तर, नई AI सिफारिशों, आपकी पोस्ट पर समुदाय प्रतिक्रियाओं, और मार्केटप्लेस अपडेट के लिए सूचनाएं मिलेंगी। सूचनाएं ऐप में, SMS के माध्यम से, और आपातकाल के लिए फोन कॉल के माध्यम से उपलब्ध हैं। आप सेटिंग्स में सूचना प्राथमिकताओं को अनुकूलित कर सकते हैं।",
      category: "technical",
    },
    {
      id: "data-privacy",
    ...
    },
    {
      ...
      answer:
        "Limited offline functionality is available. You can view previously loaded recommendations, access downloaded learning content, and enter manual data that syncs when you're back online. For full features including real-time weather, AI recommendations, and community, an internet connection is required. We're working on expanding offline capabilities.",
      answerHi:
        "सीमित ऑफ़लाइन कार्यक्षमता उपलब्ध है। आप पहले लोड की गई सिफारिशें देख सकते हैं, डाउनलोड की गई सीखने की सामग्री तक पहुंच सकते हैं, और मैनुअल डेटा दर्ज कर सकते हैं जो ऑनलाइन होने पर सिंक होता है। रियल-टाइम मौसम, AI सिफारिशें और समुदाय सहित पूर्ण सुविधाओं के लिए, इंटरनेट कनेक्शन की आवश्यकता है। हम ऑफ़लाइन क्षमताओं का विस्तार करने पर काम कर रहे हैं।",
      category: "technical",
    },
    {
      id: "mobile-app",
      ...
      answer:
        "Currently, the platform is web-based and fully responsive on mobile browsers. A dedicated mobile app for Android and iOS is in development and coming soon! The web version works seamlessly on smartphones and tablets, so you can access all features on the go.",
      answerHi:
        "वर्तमान में, प्लेटफॉर्म वेब-आधारित है और मोबाइल ब्राउज़र पर पूरी तरह से उत्तरदायी है। Android और iOS के लिए एक समर्पित मोबाइल ऐप विकास में है और जल्द ही आ रहा है! वेब संस्करण स्मार्टफोन और टैबलेट पर सहजता से काम करता है, इसलिए आप चलते-फिरते सभी सुविधाओं तक पहुंच सकते हैं।",
      category: "technical",
    },
    {
      id: "cost",
      ...
      answer:
        "Basic features including weather forecasts, learning hub, and community access are completely FREE forever. Premium features (IoT sensors, advanced AI models, priority support) have affordable subscription plans starting from ₹99/month. Many government schemes provide subsidies for digital farming tools - check with your local agricultural office.",
      answerHi:
        "मौसम पूर्वानुमान, लर्निंग हब और समुदाय पहुंच सहित बुनियादी सुविधाएं हमेशा के लिए पूरी तरह से मुफ़्त हैं। प्रीमियम सुविधाओं (IoT सेंसर, उन्नत AI मॉडल, प्राथमिकता समर्थन) में ₹99/माह से शुरू होने वाली किफायती सदस्यता योजनाएं हैं। कई सरकारी योजनाएं डिजिटल खेती उपकरणों के लिए सब्सिडी प्रदान करती हैं - अपने स्थानीय कृषि कार्यालय से जांचें।",
      category: "technical",
    },
  ];
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            ...
            >
              ...
              <div className="text-left">
                ...
                <div className="text-xs text-muted-foreground">
                  {language === "hi"
                    ? "स्मार्ट खेती सलाह प्राप्त करें"
