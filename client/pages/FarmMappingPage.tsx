          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Draw and manage your farm boundaries and sections
              </p>
            </div>
          </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <ul className="text-xs text-blue-800 space-y-1">
              ...
              <li>
                • <strong>Step 1:</strong> Click "Draw Farm Boundary" and click
                points on the map to draw your farm perimeter
              </li>
              <li>
                • <strong>Step 2:</strong> Click "Add New Section" to divide
                your farm into manageable sections
              </li>
              <li>
                • <strong>Step 3:</strong> Click on any section to add crop
                details, soil type, and track health
              </li>
              <li>
                • <strong>Step 4:</strong> Use the toolbar on the map to edit or
