        ...
        {status === "analyzing" ? (
          ...
          >
            <div className="flex items-center gap-4">
              <div className="h-12 w-12 rounded-full bg-emerald-50 flex items-center justify-center text-2xl">
                🩺
              </div>
          ...
          >
            <div className="flex items-center justify-between">
              <div className="text-sm text-muted-foreground">
                {status === "idle"
                  ? t("analysisPanel.readyToAnalyze")
                  : t("analysisPanel.analysisComplete")}
              </div>
              {status === "result" && (
                <div className="text-xs text-muted-foreground">
                  {t("analysisPanel.aiConfidenceResult")}
                </div>
              )}
            </div>
          </motion.section>
