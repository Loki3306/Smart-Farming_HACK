  ...
  useEffect(() => {
    const handleIoTData = (event: any) => {
      ...
      if (data.type === "STATUS") {
        ...
        const isStateOn =
          data.state === 1 || data.state === "ON" || data.state === true;
  ...
  const sendCommand = async (
    ...
    try {
      ...
      if (response.status === 403) {
        ...
        const data = await response.json();
        setSuccess(
          `${action} ${value ? "activated" : "deactivated"} successfully`,
        );
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2 bg-black/30 p-1 rounded-lg">
              <button
                ...
                onClick={() =>
                  setControlMode((prev) => ({ ...prev, irrigation: "manual" }))
                }
              >
                Manual
              </button>
              <button
                ...
                onClick={() =>
                  setControlMode((prev) => ({ ...prev, irrigation: "auto" }))
                }
              >
                Auto
              </button>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2 bg-black/30 p-1 rounded-lg">
              ...
              <button
                ...
                onClick={() =>
                  setControlMode((prev) => ({ ...prev, fertilization: "auto" }))
                }
              >
                Auto
              </button>
