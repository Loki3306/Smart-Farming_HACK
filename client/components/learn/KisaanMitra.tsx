...
export const KISAAN_DIALOGUES: Record<MascotContext, DialogueItem[]> = {
  welcome: [
    {
      hindi: "नमस्ते! मैं किसान मित्र हूं। आज हम मिलकर खेती सीखेंगे! 🌱",
      english:
        "Namaste! I'm KisaanMitra. Let's learn farming together today! 🌱",
    },
    {
      hindi: "स्वागत है आपका! चलिए स्मार्ट खेती का सफर शुरू करते हैं। 🚜",
      english: "Welcome! Let's begin your smart farming journey. 🚜",
    },
  ],
  new_level: [
    {
      hindi: "नया पाठ! तैयार हैं? यह जानकारी आपकी फसल को बेहतर बनाएगी।",
      english: "New lesson! Ready? This knowledge will improve your crops.",
    },
    {
      hindi: "चलिए कुछ नया सीखते हैं! यह बहुत उपयोगी होगा। 📚",
      english: "Let's learn something new! This will be very useful. 📚",
    },
  ],
  during_lesson: [
    {
      hindi: "ध्यान से पढ़ें, यह महत्वपूर्ण जानकारी है! ✍️",
      english: "Read carefully, this is important information! ✍️",
    },
    {
      hindi: "क्या आप जानते थे? यह तरीका पानी की 40% बचत करता है!",
      english: "Did you know? This method saves 40% water!",
    },
  ],
  quiz_correct: [
    {
      hindi: "शाबाश! बिल्कुल सही जवाब! 🎉",
      english: "Excellent! That's the correct answer! 🎉",
    },
    {
      hindi: "वाह! आप तो एक्सपर्ट बन रहे हैं! ⭐",
      english: "Wow! You're becoming an expert! ⭐",
    },
    {
      hindi: "बहुत बढ़िया! आगे बढ़ते रहें! 💪",
      english: "Very good! Keep going! 💪",
    },
  ],
  quiz_wrong: [
    {
      hindi: "कोई बात नहीं, गलती से ही सीखते हैं। फिर से कोशिश करें! 🤔",
      english: "No problem, we learn from mistakes. Try again! 🤔",
    },
    {
      hindi: "अरे! थोड़ा सोचिए... सही जवाब के करीब हैं आप।",
      english: "Hmm! Think a bit more... You're close to the right answer.",
    },
  ],
  level_complete: [
    {
      hindi: "बधाई हो! 🎊 आपने यह चरण पूरा कर लिया! अगला स्टेज तैयार है।",
      english:
        "Congratulations! 🎊 You completed this level! Next stage is ready.",
    },
    {
      hindi: "शानदार! एक और कदम स्मार्ट किसान बनने की ओर! 🏆",
      english: "Fantastic! One more step towards becoming a smart farmer! 🏆",
    },
  ],
  course_complete: [
    {
      hindi:
        "🏆 अद्भुत! आपने पूरा कोर्स पूरा किया! आप अब एक स्मार्ट किसान हैं!",
      english:
        "🏆 Amazing! You completed the entire course! You're now a smart farmer!",
    },
  ],
  idle_nudge: [
    {
      hindi: "अरे, कहाँ गए? चलिए आगे बढ़ते हैं! 👋",
      english: "Hey, where did you go? Let's continue! 👋",
    },
    {
      hindi: "थक गए क्या? थोड़ा और पढ़ लें, फायदा होगा!",
      english: "Tired? Read a bit more, it'll help!",
    },
  ],
  locked_level: [
    {
      hindi: "रुकिए! पहले पिछला पाठ पूरा करें। क्रम से सीखना ज़रूरी है। 🔒",
      english:
        "Wait! Complete the previous lesson first. Learning in order is important. 🔒",
    },
  ],
  tip: [
    {
      hindi: "💡 सुझाव: सुबह या शाम को पानी देना सबसे अच्छा है!",
      english: "💡 Tip: Watering in morning or evening is best!",
    },
    {
      hindi: "💡 सुझाव: मिट्टी की जांच हर 6 महीने में करें!",
      english: "💡 Tip: Test your soil every 6 months!",
    },
    {
      hindi: "💡 सुझाव: बारिश से पहले खाद न डालें, बह जाएगी!",
      english: "💡 Tip: Don't apply fertilizer before rain!",
    },
  ],
  custom: [],
};
...
export const KisaanMitra: React.FC<KisaanMitraProps> = ({
      ...
      if (dialogues && dialogues.length > 0) {
        ...
        const text =
          currentLanguage === "hindi"
            ? randomDialogue.hindi
            : randomDialogue.english;
        typeText(text);
  ...
  return (
    <div
      className={`${positionClasses[position]} flex flex-col items-start gap-2`}
    >
      {/* Speech Bubble */}
      <AnimatePresence>
          ...
          >
            <div className="space-y-1">
              ...
              >
                ...
                <span>
                  {currentLanguage === "hindi" ? "कोई टिप दो" : "Give me a tip"}
                </span>
              </button>
              <button
                type="button"
      ...
      >
        ...
        >
          ...
          <motion.path
              ...
              d:
                currentState === "celebrating"
                  ? [
                      ...
                      "M45 75 Q25 82, 23 105 Q21 128, 28 143",
                      "M45 75 Q30 85, 28 105 Q26 125, 32 140",
                    ]
                  : "M45 75 Q30 85, 28 105 Q26 125, 32 140",
            }}
            transition={{
              duration: 0.5,
              repeat: currentState === "celebrating" ? 3 : 0,
            }}
          />
          <motion.path
            d="M45 75 Q30 85, 28 105 Q26 125, 32 140"
          ...
          >
            ...
            <motion.g
              animate={{
                rotate:
                  currentState === "waving" || currentState === "celebrating"
                    ? [0, 10, -5, 10, 0]
                    : 0,
              }}
              transition={{
          ...
          <motion.g animate={headControls}>
            ...
            {/* Hair/Sideburns */}
            <path
              d="M42 35 Q40 45, 42 55"
              stroke="#2D1B0E"
              strokeWidth="2"
              fill="none"
            />
            <path
              d="M88 35 Q90 45, 88 55"
              stroke="#2D1B0E"
              strokeWidth="2"
              fill="none"
            />
            ...
            {/* Nose */}
            <path d="M65 42 L62 50 Q65 52, 68 50 L65 42" fill="#C49A6C" />
            ...
            <motion.ellipse
              ...
              cy="60"
              rx={
                isMouthOpen && (currentState === "speaking" || isTyping) ? 5 : 3
              }
              ry={
                isMouthOpen && (currentState === "speaking" || isTyping) ? 4 : 2
              }
              fill="#8B4513"
              animate={{
                ry: isMouthOpen ? 4 : 2,
...
export const WelcomeMascot: React.FC<{ onDismiss?: () => void }> = ({
  onDismiss,
}) => (
  <KisaanMitra
    context="welcome"
