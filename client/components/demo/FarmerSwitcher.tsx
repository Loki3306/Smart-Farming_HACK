    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          ...
          aria-expanded={open}
          className={cn(
            "justify-between bg-card text-foreground border-border h-11 px-4 shadow-sm hover:bg-accent hover:text-accent-foreground",
            className,
          )}
        >
      ...
      <PopoverContent className="w-[300px] p-0" align="end">
        <div className="p-4 space-y-3">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <span className="font-semibold">
                  {currentFarmer?.name || user?.fullName}
                </span>
                <br />
          ...
          <div className="space-y-1">
            <h4 className="text-xs font-medium text-muted-foreground px-2 pb-1">
              Switch User
            </h4>
          ...
          <div className="pt-2 border-t space-y-2">
            <div className="text-xs text-muted-foreground">
              💡 Each farmer has different sensor data to showcase AI
              adaptability
            </div>
