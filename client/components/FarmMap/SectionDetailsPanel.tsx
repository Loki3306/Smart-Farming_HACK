...
export const SectionDetailsPanel: React.FC<SectionDetailsPanelProps> = ({
  ...
  const handleNeighbors = async () => {
    ...
    try {
      const neighbors = await farmGeometryService.getNeighboringSections(
        farmId,
        sectionId,
      );
      if (neighbors.length === 0) {
        ...
        const neighborsList = neighbors
          .map(
            (n) =>
              `${n.section_name} (${n.shared_boundary_length_meters.toFixed(1)}m shared)`,
          )
          .join("\n");
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="p-3 bg-sky-50 rounded">
          ...
          <p className="text-xs text-gray-600">
            {section.area_sq_meters?.toFixed(0)} m²
          </p>
        </div>
        ...
        <div>
          ...
          {isEditing ? (
            ...
            <p className="text-gray-900">
              {section.crop_type || "Not specified"}
            </p>
          )}
        </div>
        ...
        <div>
          ...
          {isEditing ? (
            ...
            <p className="text-gray-900">
              {section.soil_type || "Not specified"}
            </p>
          )}
        </div>
        ...
        <div>
          ...
          {isEditing ? (
            ...
            <p className="text-gray-900">
              {section.irrigation_type || "Not specified"}
            </p>
          )}
        </div>
        ...
        {/* Health Score */}
        {section.health_score !== null &&
          section.health_score !== undefined && (
            <div>
        ...
        <div className="pt-4 border-t border-gray-200 text-xs text-gray-500 space-y-1">
          ...
          {section.last_analysis_date && (
            <p>
              Last Analysis:{" "}
              {new Date(section.last_analysis_date).toLocaleString()}
            </p>
          )}
        </div>
      </div>
