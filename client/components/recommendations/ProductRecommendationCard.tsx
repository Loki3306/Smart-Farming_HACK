...
> = ({ product, farmSize, onViewInMarketplace, onFindDealers }) => {
  ...
  return (
    ...
    >
      <Card
        className={`h-full overflow-hidden shadow-lg hover:shadow-emerald-100/50 dark:hover:shadow-emerald-900/20 transition-all duration-300 relative group border-2 ${getCardStyle()}`}
        style={textureStyle}
      >
        ...
        <CardHeader className="pb-2 relative z-10 pt-6">
          <div className="flex justify-between items-start">
            <div className="space-y-1">
              ...
              <Badge
                variant="outline"
                className={`mb-2 capitalize border-emerald-200 text-emerald-800 bg-emerald-50/80`}
              >
          ...
          <div className="bg-white/60 dark:bg-black/20 backdrop-blur-sm p-4 rounded-xl border border-emerald-100 dark:border-emerald-800/50 shadow-sm relative overflow-hidden group-hover:border-emerald-200 transition-colors">
            ...
            <div className="flex justify-between items-center relative z-10">
              ...
              <div className="text-right">
                <Badge
                  variant="secondary"
                  className="bg-emerald-100 text-emerald-800 border-emerald-200 font-bold px-2 py-1"
                >
                  {product.npk_ratio}
                </Badge>
              </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-white/40 dark:bg-black/20 p-3 rounded-lg border border-emerald-100/50">
              ...
              <p className="font-bold text-lg text-emerald-900 dark:text-emerald-100 flex items-baseline">
                {product.quantity}
                <span className="text-xs font-normal ml-1 text-emerald-700">
                  {product.unit_type}s
                </span>
              </p>
              ...
              <div className="flex gap-1.5 mt-1">
                {product.nutrients_provided.N > 0 && (
                  <div className="grid place-items-center">
                    <span className="w-6 h-6 rounded-full bg-emerald-100 text-emerald-700 text-xs font-bold flex items-center justify-center border border-emerald-200">
                      N
                    </span>
                    <span className="text-[10px] font-bold mt-0.5">
                      {product.nutrients_provided.N}
                    </span>
                  </div>
                )}
                {product.nutrients_provided.P > 0 && (
                  <div className="grid place-items-center">
                    <span className="w-6 h-6 rounded-full bg-green-100 text-green-700 text-xs font-bold flex items-center justify-center border border-green-200">
                      P
                    </span>
                    <span className="text-[10px] font-bold mt-0.5">
                      {product.nutrients_provided.P}
                    </span>
                  </div>
                )}
                {product.nutrients_provided.K > 0 && (
                  <div className="grid place-items-center">
                    <span className="w-6 h-6 rounded-full bg-teal-100 text-teal-700 text-xs font-bold flex items-center justify-center border border-teal-200">
                      K
                    </span>
                    <span className="text-[10px] font-bold mt-0.5">
                      {product.nutrients_provided.K}
                    </span>
                  </div>
                )}
              </div>
          ...
          <div className="space-y-3 pt-2">
            ...
            <div className="bg-white/60 dark:bg-black/20 backdrop-blur-sm p-4 rounded-xl border border-emerald-100 dark:border-emerald-800/50 shadow-sm relative overflow-hidden">
              ...
              <div
                ...
                style={{
                  backgroundImage:
                    "url('data:image/svg+xml,%3Csvg width=\\'6\\' height=\\'6\\' viewBox=\\'0 0 6 6\\' xmlns=\\'http://www.w3.org/2000/svg\\'%3E%3Cg fill=\\'%23000\\' fill-opacity=\\'1\\' fill-rule=\\'evenodd\\'%3E%3Cpath d=\\'M5 0h1L0 6V5zM6 5v1H5z\\'/%3E%3C/g%3E%3C/svg%3E')",
                }}
              ></div>
              ...
              <div className="space-y-2.5 relative z-10">
                <div className="flex items-center justify-between text-sm group/dealer cursor-pointer hover:bg-emerald-50/50 p-1 -mx-1 rounded transition-colors">
                  ...
                  <span className="text-xs font-mono text-emerald-700 bg-emerald-50 px-1.5 py-0.5 rounded border border-emerald-100">
                    2.3 km
                  </span>
                </div>
                <div className="flex items-center justify-between text-sm group/dealer cursor-pointer hover:bg-emerald-50/50 p-1 -mx-1 rounded transition-colors">
