...
const signupMessagesEn: AuthGuideMessage[] = [
  {
    greeting: "Namaste!",
    mainMessage:
      "I'm Ravi, your farming companion. I've been farming for 20 years and now I help new friends like you get started. Let me guide you through this - it's easier than planting your first crop!",
    icon: Hand,
  },
  {
  ...
  },
  {
    ...
    mainMessage:
      "Your mobile number is like having a direct line to the farm. I'll send you alerts about weather, crop issues, and important updates - right when you need them.",
    tips: [
  ...
  },
  {
    ...
    mainMessage:
      "Choose a password you'll remember but others won't guess. Think of it like the lock on your shed - keep it strong to protect your farm data!",
    tips: [
  ...
  },
  {
    ...
    mainMessage:
      "Your location helps me give you accurate weather forecasts, seasonal advice, and connect you with nearby farmers. Every region has its own farming wisdom!",
    tips: [
  ...
  },
  {
    ...
    mainMessage:
      "Don't worry if you're new! I've taught many beginners. Whether you're just starting or have years of experience, I'll adjust my guidance to match your needs.",
    tips: [
  ...
  },
  {
    ...
    mainMessage:
      "Look at that - you did great! Now click 'Create Account' and let's start this farming journey together. I'll be with you every step of the way!",
...
const signupMessagesHi: AuthGuideMessage[] = [
  {
    greeting: "नमस्ते!",
    mainMessage:
      "मैं रवि हूं, आपका खेती साथी। मैं 20 साल से खेती कर रहा हूं और अब आप जैसे नए दोस्तों की मदद करता हूं। चलिए शुरू करते हैं - ये पहली फसल उगाने से भी आसान है!",
    icon: Hand,
  },
  {
    greeting: "मैं आपको क्या बुलाऊं?",
    mainMessage:
      "आपका नाम मेरे लिए ज़रूरी है - इससे हमारी दोस्ती बनेगी। अपना असली नाम लिखें, जैसे आप पड़ोसी से मिलते वक्त बताते हैं।",
    tips: ["अपने दस्तावेजों वाला नाम लिखें", "इससे सब कुछ आपके हिसाब से होगा"],
    fieldToWatch: "fullName",
    reactions: {
  ...
  },
  {
    ...
    mainMessage:
      "आपका मोबाइल नंबर खेत की सीधी लाइन है। मौसम, फसल की समस्या, और ज़रूरी अपडेट - सब मैं आपको भेजूंगा।",
    tips: [
  ...
  },
  {
    ...
    mainMessage:
      "ऐसा पासवर्ड चुनें जो आप याद रखें पर दूसरे न समझ पाएं। सोचिए जैसे आपके गोदाम का ताला - मज़बूत रखें!",
    tips: [
      "कम से कम 6 अक्षर",
  ...
  },
  {
    ...
    mainMessage:
      "आपकी लोकेशन से मैं सही मौसम, मौसमी सलाह, और पास के किसानों से जोड़ सकता हूं। हर इलाके की अपनी खेती की समझ होती है!",
    tips: [
  ...
  },
  {
    ...
    mainMessage:
      "नए हों तो चिंता न करें! मैंने कई शुरुआती को सिखाया है। नए हों या पुराने किसान - मैं आपके हिसाब से मदद करूंगा।",
    tips: [
  ...
  },
  {
    ...
    mainMessage:
      "देखा - आपने बढ़िया किया! अब 'Create Account' पर क्लिक करें और खेती का सफर शुरू करें। मैं हर कदम पर साथ हूं!",
...
const loginMessagesEn: AuthGuideMessage[] = [
  {
    ...
    mainMessage:
      "Ravi here! Good to see you again. Let's get you back to your farm dashboard. Your crops are waiting!",
    icon: Hand,
  },
  {
    greeting: "Your number?",
    mainMessage:
      "Enter the mobile number you used when signing up. That's how I know it's really you and not someone else trying to access your farm.",
    tips: ["Same 10-digit number from signup", "Starts with 6, 7, 8, or 9"],
    fieldToWatch: "phone",
    reactions: {
  ...
  },
  {
    ...
    mainMessage:
      "Enter your secure password. If you've forgotten it, don't worry - there's a reset option below. We all forget things sometimes!",
    fieldToWatch: "password",
    reactions: {
  ...
  },
  {
    ...
    mainMessage:
      "Click 'Sign In' and you'll be back at your dashboard with all your farm data, insights, and real-time monitoring. Let's get back to work!",
...
const loginMessagesHi: AuthGuideMessage[] = [
  {
    ...
    mainMessage:
      "रवि यहां है! फिर से मिलकर अच्छा लगा। चलिए आपको वापस खेत के डैशबोर्ड पर ले चलते हैं। आपकी फसलें इंतज़ार कर रही हैं!",
    icon: Hand,
  },
  {
    greeting: "आपका नंबर?",
    mainMessage:
      "साइनअप वाला मोबाइल नंबर डालें। इससे मुझे पता चलेगा कि आप ही हैं, कोई और नहीं जो आपके खेत की जानकारी देखने की कोशिश कर रहा।",
    tips: ["साइनअप वाला 10 अंकों का नंबर", "6, 7, 8, या 9 से शुरू होना चाहिए"],
    fieldToWatch: "phone",
    reactions: {
  ...
  },
  {
    greeting: "और पासवर्ड?",
    mainMessage:
      "अपना पासवर्ड डालें। भूल गए तो चिंता नहीं - नीचे रीसेट का ऑप्शन है। सबके साथ होता है कभी-कभी!",
    fieldToWatch: "password",
    reactions: {
  ...
  },
  {
    greeting: "तैयार हैं!",
    mainMessage:
      "'Sign In' पर क्लिक करें और वापस डैशबोर्ड पर पहुंचें - सारा डेटा, जानकारी, और लाइव मॉनिटरिंग। काम पर लौटते हैं!",
...
export const AuthGuide = ({
  ...
  useEffect(() => {
    ...
    if (
      currentField === currentMessage.fieldToWatch &&
      currentMessage.reactions?.onFocus
    ) {
            ...
            <div className="w-[380px] max-w-[calc(100vw-48px)] relative">
              ...
              <div className="relative bg-gradient-to-br from-card/95 via-card/90 to-emerald-50/50 backdrop-blur-xl border-2 border-emerald-200/50 rounded-3xl shadow-2xl overflow-hidden">
                ...
                <motion.div
                  ...
                  style={{
                    backgroundImage:
                      "radial-gradient(circle at 20% 50%, rgba(16, 185, 129, 0.1) 0%, transparent 50%), radial-gradient(circle at 80% 80%, rgba(5, 150, 105, 0.1) 0%, transparent 50%)",
