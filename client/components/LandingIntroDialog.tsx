...
const content = {
  en: {
    ...
    description:
      "Your AI-powered smart farming companion. Get real-time insights, weather forecasts, and expert recommendations for better yields.",
  ...
  hi: {
    ...
    description:
      "आपका AI-संचालित स्मार्ट खेती साथी। रियल-टाइम जानकारी, मौसम के पूर्वानुमान और बेहतर उपज के लिए विशेषज्ञ सुझाव पाएं।",
...
export const LandingIntroDialog = ({
  isAuthenticated,
}: LandingIntroDialogProps) => {
            ...
            <div className="relative p-5 pt-4">
              ...
              >
                <h3 className="text-lg font-bold text-foreground mb-1.5">
                  {t.title}{" "}
                  <Wheat className="inline-block w-5 h-5 text-yellow-500 mb-1" />
                </h3>
